   ...
   <div v-enter-to-next-input>
       ...
       <div class='ui segment block fitted'>
         <div class='content fitted'>
           <dat-gui>
             <dat-value v-model='報告年月日' label='報告日は？' comment='新型コロナウイルス発生届の報告年月日' type='yyyymmdd' ref='first'></dat-value>
          </dat-gui>
        </div>
      </div>
         ...
         <div class='content fitted'>
           <dat-gui class='row'>
             <dat-folder name='分離・同定による病原体の検出'>
               <dat-value v-model="$data['分離・同定による病原体の検出の採取日']" label='1.採取日は？' type='yyyymmdd'></dat-value>
             ...
             <dat-folder name='検体から核酸増減法（ＰＣＲ法・ＬＡＭＰ法など）'>
               <dat-value v-model="$data['検体から核酸増減法（ＰＣＲ法・ＬＡＭＰ法など）の検出の採取日']" label='2.採取日は？' type='yyyymmdd'></dat-value>
             ...
             <dat-folder name='抗原定性検査による病原体の抗原の検出'>
               <dat-value v-model="$data['抗原定性検査による病原体の抗原の検出の採取日']" label='3.採取日は？' type='yyyymmdd'></dat-value>
             ...
             <dat-folder name='抗原定量検査による病原体の抗原の検出'>
               <dat-value v-model="$data['抗原定量検査による病原体の抗原の検出の採取日']" label='4.採取日は？' type='yyyymmdd'></dat-value>
       ...
       <div class='ui segment block fitted'>
         <div class='content fitted'>
           <dat-gui>
             <dat-value v-model='発病年月日' label='発病日は？' comment='新型コロナウイルス発生届の発病年月日' type='yyyymmdd'></dat-value>
       ...
       <div class='ui segment block fitted'>
         <div class='content fitted'>
           <dat-gui>
             <dat-value v-model='感染したと推定される年月日' label='感染日は？' comment='新型コロナウイルス発生届の感染年月日' type='yyyymmdd'></dat-value>
       ...
       <div class='ui segment block fitted' v-if="患者の類型 == '感染症死亡者の死体' || 患者の類型 == '感染症死亡疑い者の死体'">
         <div class='content fitted'>
           <dat-gui>
             <dat-value v-model='死亡年月日' label='死亡日は？' comment='新型コロナウイルス発生届の死亡年月日' type='yyyymmdd'></dat-value>
          </dat-gui>
        </div>
      </div>
       <div class='ui segment block fitted green'>
         ...
         <div class='content fitted'>
           <dat-gui>
             <dat-folder name='感染地域'>
               ...
               <dat-value v-model='感染が国外への出国日' label='入国日' type='yyyymmdd'></dat-value>
               <dat-value v-model='感染が国外での帰国日' label='出国日' type='yyyymmdd'></dat-value>
            </dat-folder>
          </dat-gui>
        </div>
      </div>
         ...
         <div class='content fitted'>
           <dat-gui>
             <dat-folder :name='`１回目は${コロナのワクチン１回目の年齢}の時に${コロナのワクチン１回目の製造会社}` | toZen'>
               ...
               <dat-value v-model='コロナのワクチン１回目の接種年月日' label='１回目の接種日は？'  type='yyyymmdd'></dat-value>
            </dat-folder>
             <dat-folder :name='`２回目は${コロナのワクチン２回目の年齢}の時に${コロナのワクチン２回目の製造会社}` | toZen'>
               ...
               <dat-value v-model='コロナのワクチン２回目の接種年月日' label='２回目の接種日は？'  type='yyyymmdd'></dat-value>
            </dat-folder>
             <dat-folder :name='`３回目は${コロナのワクチン３回目の年齢}の時に${コロナのワクチン３回目の製造会社}` | toZen'>
               ...
               <dat-value v-model='コロナのワクチン３回目の接種年月日' label='３回目の接種日は？'  type='yyyymmdd'></dat-value>
            </dat-folder>
          </dat-gui>
        </div>
      </div>
