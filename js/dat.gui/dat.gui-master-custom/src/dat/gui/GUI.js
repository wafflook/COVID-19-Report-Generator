...
common.extend(
  ...
  /** @lends GUI.prototype */
  {
    ...
    /**
     * recursively generate dat.gui controls for any object
     * stellatigre@https://gist.github.com/stellatigre/ba8a4e4eab1d701be918
     */
    addObject: function (recursiveObject, folderName, guiElement) {
      if (guiElement === undefined) {
          guiElement = this;
          if (folderName === undefined) {
              // we add random chars to prevent id collisions in dat.gui
              folderName = "object root " + Math.random().toString(36).substring(12);
          }
      };
      var folder = guiElement.addFolder(folderName);
      for (var v of Object.keys(recursiveObject)) {
          if (typeof(recursiveObject[v]) === "object") {
...
function augmentController(gui, li, controller) {
  ...
  common.extend(controller, /** @lends Controller.prototype */ {
    ...
    /**
     * Readonly the given controller from the GUI.
     * @param {Controller} controller
     * @instance
     */
    ...
    /**
     * Placeholder the given controller from the GUI.
     * @param {Controller} controller
     * @instance
     */
    ...
    /**
     * Password the given controller from the GUI.
     * @param {Controller} controller
     * @instance
     */
